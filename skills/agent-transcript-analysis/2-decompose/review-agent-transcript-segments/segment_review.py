...
(`2-decompose/review-agent-transcript-segments`) and the learning skill
(`2-decompose/learn-from-agent-transcript-segment-corrections`):
...
- **The correction log is append-only and replayable.** Each entry records
  ...
  `before`/`after` and an optional context `note`. `learn-from-agent-transcript-segment-corrections`
