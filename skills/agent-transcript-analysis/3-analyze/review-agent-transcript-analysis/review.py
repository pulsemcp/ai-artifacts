...
`segment_review.py` (bundled with the `review-agent-transcript-segments` skill) is the
...
`review-agent-transcript-analysis`) and the learning skill (`learn-from-agent-transcript-analysis-corrections`).
The contract is
