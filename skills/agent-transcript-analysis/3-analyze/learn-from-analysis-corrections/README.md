...
The feedback half of the phase-3 review loop. Reads the human corrections captured by `review-analysis` and **flags concrete improvement opportunities** for the phase-3 analyzers — it does not edit any skill.
...
learn-from-analysis-corrections   →  flagged opportunities for the phase-3 analyzers
        └────────────────── close the loop ──────────────────┘
```
