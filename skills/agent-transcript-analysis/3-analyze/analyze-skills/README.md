...
- **Philosophy doc is the source of truth for create/modify/delete calls.** Each analyzer cross-checks `references/philosophy-on-skills.md` before emitting a recommendation.
