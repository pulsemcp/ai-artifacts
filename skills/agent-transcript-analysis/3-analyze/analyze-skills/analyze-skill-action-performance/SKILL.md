...
description: >
  ...
  whether it helped or hurt the goal, and whether its token / turn cost was
  proportionate. Output recommendations to modify the body of Skills that
  underperform, or to delete Skills that are net-negative.
...
- [ ] For each Skill invocation in the segment, reconstruct what the Skill instructed the agent to do
- [ ] Assess outcome:
  - **helpful** — moved the segment toward the goal, closed-loop or got close
