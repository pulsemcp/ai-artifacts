...
- [ ] For each MCP tool call in `segment_turns`, look at the call args and the response. Was the response useful? Was it too big? Was it too small? Did it give the agent what it needed to take the next step?
