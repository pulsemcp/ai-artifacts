...
- **Philosophy docs gate the final report.** Recommendations that conflict with `references/philosophy-on-{skills,mcp}.md` are dropped or flagged before they leave Tier 3.
